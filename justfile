...
install-cilium:
    ...
    # Cilium 1.19 uses Gateway API v1.4.x. Keep this pin aligned with the
    # installed Cilium minor so new GatewayClasses can publish valid status.
    ...
    for crd in gatewayclasses gateways httproutes grpcroutes referencegrants tlsroutes tcproutes udproutes backendtlspolicies; do
