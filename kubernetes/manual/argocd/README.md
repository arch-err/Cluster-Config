...
ArgoCD uses direct OIDC with Pocket ID. It is an **infra** component declared in `kubernetes/infra.yaml`; runtime settings are in `kubernetes/values/infra/argocd.yaml`.
